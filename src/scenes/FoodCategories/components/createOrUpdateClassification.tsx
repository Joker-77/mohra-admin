...
@observer
class CreateOrUpdateClassification extends React.Component<ICreateOrUpdateClassificationProps, any> {
  ...
  onArChange = (e: any) => {
    ...
    this.setState({arName:{ ...this.validateArName(value),
      value,}});
  };

  onEnChange = (e: any) => {
    let value= e.target.value;
    this.setState({enName:{ ...this.validateEnName(value),
      value,}});
  };
    ...
    return (
      <Modal
        ...
        footer={[
          ...
          <Button key="submit" type="primary" loading={this.props.isSubmittingClassification} onClick={this.handleSubmit}>
      ...
      >
         <Form ref={this.props.formRef}>
          ...
          <FormItem label={L('ArName')} 
           initialValue={ classificationModel !== undefined && classificationModel.arName ? classificationModel.arName : undefined}
           name="arName" 
          ...
          <FormItem label={L('EnName')} name="enName"  {...formItemLayout}
           initialValue={ classificationModel !== undefined && classificationModel.enName ? classificationModel.enName : undefined}
          ...
          <EditableImage
           ...
           //   imageSrc={ classificationModel !== undefined && classificationModel.imageUrl ? classificationModel.imageUrl : undefined}
            //  prefaredDimensionsMessage={''}
              onSuccess={fileName => {
                document.getElementById('classification-image')!.setAttribute("value", fileName);
              }}
          />
</FormItem>
          </Col>
